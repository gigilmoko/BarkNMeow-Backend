    ...
    await sendEmail({
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    <p>Dear ${user.name},</p>
                    <p>Thank you for choosing Bark 'n Meow for your recent purchase. We are delighted to confirm that your order has been received and is currently in the process of being prepared for shipment.</p>
                </div>
                <table>
                    <tr>
                        <th>Product</th>
